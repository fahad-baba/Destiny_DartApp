...
//if(userChoice == 1){
//  if(storyNumber == 0) storyNumber = 2;
//  if(storyNumber == 1) storyNumber = 2;
//  if(storyNumber == 2) storyNumber = 5;
////  if(storyNumber == 3) storyNumber = null;
////  if(storyNumber == 4) storyNumber = null;
////  if(storyNumber == 5) storyNumber = null;
//} else {
//  if(storyNumber == 0) storyNumber = 1;
//  if(storyNumber == 1) storyNumber = 3;
//  if(storyNumber == 2) storyNumber = 4;
////  if(storyNumber == 3) storyNumber = null;
////  if(storyNumber == 4) storyNumber = null;
////  if(storyNumber == 5) storyNumber = null;
//}
